...
subprocess.run(['kicad-cli', 'pcb', 'export', 'step', '--no-dnp', 'front/scratch/front_top.kicad_pcb', '-o', 'front/3d_models/front_top.step'], stdout=subprocess.DEVNULL)
subprocess.run(['kicad-cli', 'pcb', 'export', 'step', '--no-dnp', 'front/scratch/front_sensor_C.kicad_pcb', '-o', 'front/3d_models/front_sensor.step'], stdout=subprocess.DEVNULL)
subprocess.run(['kicad-cli', 'pcb', 'export', 'step', '--no-dnp', 'front/scratch/front_back.kicad_pcb', '-o', 'front/3d_models/front_back.step'], stdout=subprocess.DEVNULL)

subprocess.run(['kicad-cli', 'pcb', 'export', 'stl', '--no-dnp', 'front/scratch/front_top.kicad_pcb', '-o', 'front/3d_models/front_top.stl'], stdout=subprocess.DEVNULL)
